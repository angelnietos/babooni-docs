...
<h1 align="center">Desarrollo local — referencia</h1>
...
| `ideauto-recalls-api` | *(M0 stub — MSSQL / F83 en M1+)* | `apps/clientes/ideauto/recalls/backend/` |
...
# Mapa scripts: docs/runbooks/tools-layout.md
```
...
- [tools-layout.md](../runbooks/tools-layout.md)
